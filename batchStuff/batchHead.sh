...
#SBATCH -t 00:30:00     # time limit for job in HH:MM:SS
#SBATCH -N 1            # number of CPU cores requested
#
# Redirect the job's stdout
#SBATCH -o /pic/projects/belle/voss771/bToD/jobId_%j.out
#
# Redirect the job's stderr
#SBATCH -e /pic/projects/belle/voss771/bToD/jobId_%j.err
#
...
export LD_LIBRARY_PATH=/people/voss771/bToD/:`root-config --libdir`:$LD_LIBRARY_PATH
export BASF_MODULE_DIR=/people/voss771/bToD/:$BASF_MODULE_DIR
