...
export LD_LIBRARY_PATH=/people/voss771/bToDDoubleStar/:`root-config --libdir`:$LD_LIBRARY_PATH
export BASF_MODULE_DIR=/people/voss771/bToDDoubleStar/:$BASF_MODULE_DIR
